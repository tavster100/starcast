...
export function CTASection() {
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      <motion.div ref={ref} style={{ scale, opacity }} className="container px-4 md:px-6">
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="relative z-10 flex flex-col items-center text-center py-16 px-4 md:py-24 md:px-8">
            ...
            >
              Alătură-te sutelor de creatori care își construiesc carierele și conectează cu publicul prin TikTok Live
            </motion.p>
